...
<html lang="en">
<head>
    <title>Reporte de Asignación de Equipos</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
...
<div class="header">
    ...
    <h2 class="text-center">Reporte de Asignación de Equipos</h2>
    <table id="mitabla" class="table table-striped">
        ...
        <tbody>
            @if(is_array($asignacion_equipos) || is_object($asignacion_equipos))
                @foreach ($asignacion_equipos as $asignacion)
                    <tr>
            ...
            @else
                <tr>
                    <td colspan="3">No se encontraron asignaciones.</td>
                </tr>
            @endif
        </tbody>
    </table>
