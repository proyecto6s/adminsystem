...
@section('content_header')
    <h1 class="text-center">CREAR NUEVO PERMISO</h1>
@stop
                ...
                <form action="{{ route('permisos.insertar') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="Id_Objeto" name="Id_Objeto" class="form-select select2" required>
                            ...
                            @foreach ($objetos as $Objeto)
                                <option value="{{ $Objeto->Id_Objetos }}">{{ $Objeto->Objeto }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="Permiso_Insercion" class="form-select" name="Permiso_Insercion" required>
                            <option value="PERMITIDO" @if(old('Permiso_Insercion') == 'PERMITIDO') selected @endif>PERMITIDO</option>
                            <option value="DENEGADO" @if(old('Permiso_Insercion') == 'DENEGADO') selected @endif>DENEGADO</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="Permiso_Eliminacion" class="form-select" name="Permiso_Eliminacion" required>
                            <option value="PERMITIDO" @if(old('Permiso_Eliminacion') == 'PERMITIDO') selected @endif>PERMITIDO</option>
                            <option value="DENEGADO" @if(old('Permiso_Eliminacion') == 'DENEGADO') selected @endif>DENEGADO</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="Permiso_Actualizacion" class="form-select" name="Permiso_Actualizacion" required>
                            <option value="PERMITIDO" @if(old('Permiso_Actualizacion') == 'PERMITIDO') selected @endif>PERMITIDO</option>
                            <option value="DENEGADO" @if(old('Permiso_Actualizacion') == 'DENEGADO') selected @endif>DENEGADO</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="Permiso_Consultar" class="form-select" name="Permiso_Consultar" required>
                            <option value="PERMITIDO" @if(old('Permiso_Consultar') == 'PERMITIDO') selected @endif>PERMITIDO</option>
                            <option value="DENEGADO" @if(old('Permiso_Consultar') == 'DENEGADO') selected @endif>DENEGADO</option>
                        </select>
                    </div>
