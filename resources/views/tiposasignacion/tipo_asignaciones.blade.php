...
<head>
    ...
    <title>Reporte de Tipos de Asignación</title>
    <style>
...
<body>
    <div class="header">
        <div class="report-details">
            <h3>Reporte de Tipos de Asignación</h3>
            <p>Constructora Traterra S. de R.L</p>
            <h3>Total Tipos de Asignación: {{ $tipoAsignaciones->count() }}</h3>
        </div>
            ...
            <tbody>
                @foreach ($tipoAsignaciones as $tipoAsignacion)
                    <tr>
                        ...
                        <td>{{ $tipoAsignacion->TIPO_ASIGNACION }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
